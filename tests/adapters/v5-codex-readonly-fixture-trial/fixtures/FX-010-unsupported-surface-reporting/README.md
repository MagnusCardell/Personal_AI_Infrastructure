# FX-010 Unsupported Surface Reporting
...
The fixture validates metadata for unsupported-surface reporting. Unsupported Pulse, Memory, ISA, hook, launcher, inference, and runtime adapter surfaces must be reported, not silently ignored.
